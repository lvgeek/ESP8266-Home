...
//then goes to sleep for 5 minutes
...
char* tempTopic0 = "/house/attic";
char* tempTopic1 = "/house/duct";
char* tempTopic2 = "/house/return";
...
void loop(){
  ...
  //updates the MQTT temperatures every 5 minutes or so
